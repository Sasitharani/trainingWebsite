    ...
    <header className="bg-black text-white p-4">
      <nav className="flex justify-between items-center">
        ...
        <ul className="flex space-x-4">
          ...
          {isLoggedIn ? (
            <>
              {email && <li className="hover:text-gray-400">{email.slice(0, email.indexOf('@'))}</li>}
              <li><Link to="/logout" className="hover:text-gray-400 hover:shadow-[0_0_20px_5px_rgba(0,255,255,0.8)]">Logout</Link></li>
            </>
          ) : (
